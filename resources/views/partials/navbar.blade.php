<nav class="bg-white text-md p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button class="bg-blue-500 items-center text-white px-4 py-2 rounded-md">
                <ion-icon class="" name="search"></ion-icon>
            </button>
            @auth
...
<nav class="bg-gray-800 p-4">
    <div class="container m-auto flex justify-center items-center">
        ...
        <div class="hidden md:flex space-x-8">
            <a href="/" class=" text-gray-300 text-lg {{ request()->is('/') ? 'font-bold' : '' }}">Beranda</a>
            <a href="/teknologi"
                class="text-gray-300 text-lg {{ request()->is('teknologi') ? 'font-bold' : '' }}">Teknologi</a>
            <a href="/olahraga"
                class="text-gray-300 text-lg {{ request()->is('olahraga') ? 'font-bold' : '' }}">Olahraga</a>
            <a href="/kuliner"
                class="text-gray-300 text-lg {{ request()->is('kuliner') ? 'font-bold' : '' }}">Kuliner</a>
            <a href="/kesehatan"
                class="text-gray-300 text-lg {{ request()->is('kesehatan') ? 'font-bold' : '' }}">Kesehatan</a>
            <a href="/otomotif"
                class="text-gray-300 text-lg {{ request()->is('otomotif') ? 'font-bold' : '' }}">Otomotif</a>
            <a href="/kontak" class="text-gray-300 text-lg {{ request()->is('kontak') ? 'font-bold' : '' }}">Kontak</a>
        </div>
    </div>
</nav>