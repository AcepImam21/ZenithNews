...
@section('container')
    {{-- Hero Section --}}
    <div class="bg-cover bg-center h-96 md:h-128 lg:h-160 flex items-center justify-center"
        ...
        <div class="text-center text-white">
            ...
            <a href="#" class="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600">Selengkapnya</a>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            @foreach ($posts as $post)
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <h2 class="text-md text-gray-500 mb-2">{{ $post->category->slug }} </h2>
    ...
    <div class="container mx-auto p-4 my-4">
        <h1 class="text-2xl font-bold mb-4">Berita {{ $post->category->slug }}</h1>
    ...
    <div class="container mx-auto p-4 my-4">
        <h1 class="text-2xl font-bold mb-4">Berita {{ $posts->first()->category->slug }}</h1>
