            ...
            <ul class="flex flex-col py-4 space-y-1">
                <li class="px-5 hidden md:block">
                    <div class="flex flex-row items-center h-8">
                        <div class="text-sm font-light tracking-wide text-gray-400 uppercase">Utama</div>
                    </div>
                </li>
                <li>
                    <a href="#"
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Post Saya</span>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Kategori Post</span>
                    </a>
                </li>
            </ul>
